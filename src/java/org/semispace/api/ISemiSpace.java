 ...
 * @author park renamed to ISemiSpace and moved to org.semispace.api
 */
public interface ISemiSpace {
     ...
     */
    public SemiLease write(ISemiSpaceTuple obj, long duration);
     ...
     */
    public ISemiSpaceTuple read(ISemiSpaceTuple template, long duration);

    /**
     * Same as read, with duration 0
     * @see #read(ISemiSpaceTuple, long)
     */
    public ISemiSpaceTuple readIfExists(ISemiSpaceTuple template);

    /**
     * Same as read, except that the object is removed from the space.
     * @see #read(ISemiSpaceTuple, long)
     */
    public ISemiSpaceTuple take(ISemiSpaceTuple template, long duration);

    /**
     * Same as take, with a duration of 0
     * @see #take(ISemiSpaceTuple, long)
     * @see #read(ISemiSpaceTuple, long)
     */
    public ISemiSpaceTuple takeIfExists(ISemiSpaceTuple template);
     ...
     */
    public SemiEventRegistration notify(ISemiSpaceTuple template,
            ISemiEventListener listener,
            long duration);
